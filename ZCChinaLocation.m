...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        self.excludeRectangle = [[NSArray alloc] initWithObjects:
                                 ...
                                 [Rectangle rectangleWithLa1:22.214821 lo1:113.525290 la2:22.108066 lo2:113.602924],//澳门
                                 [Rectangle rectangleWithLa1:22.475444 lo1:113.873634 la2:22.130807 lo2:114.452819],//香港
                                 nil];
    }
    return self;
}
